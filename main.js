...
document.getElementById('verificationName').addEventListener('submit', function(e) {
    ...
    // Validasi nama
    const validNames = ['Princess Sherly', 'Sherly', 'Sherlynda'];
...
// Step 2: Verifikasi Fans Zidane
// Step 2: Verifikasi Fnas Zidane
...
const animationTimeline = () => {
    ...
    const textBoxChars = document.getElementsByClassName("Thanks-chatbox")[0];
